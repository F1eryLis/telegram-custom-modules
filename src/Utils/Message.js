...
const data = [{name: 'Page A', uv: 400, pv: 2400, amt: 2400}, {name: 'Page B', uv: 300, pv: 4800, amt: 4800}, {name: 'Page C', uv: 350, pv: 7200, amt: 7200}];
        ...
        if (!isValidEntity(entity)) {
            ...
            switch (type['@type']) {
                ...
                case 'textEntityTypeCode': {
                    ...
                    if(entityText.indexOf('kanban') !== -1)
                    {
                        result.push(<Board initialBoard={board} />);
                        break;
                    }
